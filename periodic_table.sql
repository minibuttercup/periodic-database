...
--
-- Name: properties_atomic_number_idx; Type: INDEX; Schema: public; Owner: freecodecamp
--

CREATE INDEX properties_atomic_number_idx ON public.properties USING btree (atomic_number);
